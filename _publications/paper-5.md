...
<img src="/images/paper-4-1" alt="PPGAN" title="PPGAN" width="700" height="500" />

<img src="/images/paper-4-6" alt="PPGAN flow" title="PPGAN flow" width="700" height="500" />

## Methods
* Privacy-preserving Generative Adversarial Network (PPGAN)

<img src="/images/paper-4-9" alt="PPGAN algorithm" title="PPGAN algorithm" width="700" height="500" />
...
<img src="/images/paper-4-8" alt="Generated images with four different $$\eplison$$ on MNIST dataset are plotted in each group." title="Generated images with four different $$\eplison$$ on MNIST dataset are plotted in each group." width="700" height="500" />
...
<img src="/images/paper-4-7" alt="Loss of Non-private Case and Private Case." title="Loss of Non-private Case and Private Case." width="700" height="500" />
...
budgets. The larger the score value, the better the quality of the data generated by the generator. The figure shows the distribution of the generate scores of PPGAN in the case of $$\eplison$$= 20; 10; 5.
...
$$I(G) = \exp (Ex \sim G(z)KL(\Pr (y|x)||\Pr (y)))$$

Generate scores:

$$P(G) = |\frac{{I(G) - mean(I(G))}}{{\max (I(G)) - \min (I(G))}}|$$

<img src="/images/paper-4-2" alt="Result-1." title="Result-1." width="700" height="500" />

<img src="/images/paper-4-3" alt="Result-2." title="Result-2." width="700" height="500" />
...
<img src="/images/paper-4-4" alt="Result-3." title="Result-3." width="700" height="500" />

<img src="/images/paper-4-5" alt="Result-4." title="Result-4." width="700" height="500" />
